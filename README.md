...
without access to accurate or timely agricultural insights. To address
this gap, our project introduces a Smart Agriculture Advisory
Platform designed specifically for coconut plantations. This platform
uses machine learning models, weather and soil data, and cloud-
based APIs to deliver personalized, real-time guidance to farmers. It
is divided into four key modules: an Irrigation Recommendation
Engine, a Crop Advisory & Yield Prediction Engine, a Disease
Detection & Farmer Notification System, and a Nutrient Deficiency
Detection & Fertilizer Recommendation System. Together, these
